...
public class VCGitWindow {
    ...
    private void init() {
        this.gitURLField = new JTextField();
        this.gitURLField.setSize(40, 20);
    ...
    private Container createPane() {
        ...
        topPanel.add(new Label("Git URL"));
        topPanel.add(this.gitURLField);
    ...
    public String getURL(){
    	return this.gitURLField.getText();
    }
